...
/**
 * Servlet implementation class retracteventservlet
 */
@WebServlet("/retracteventservlet")
public class retracteventservlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public retracteventservlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		retracteventdao d = new retracteventdao();
