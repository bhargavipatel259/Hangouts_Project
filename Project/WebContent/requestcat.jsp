...
<header id="masthead" class="site-header fix-header header-1">
		...
		<form action="requestcatservlet" method="post">
					<div class="newsletter-form clearfix">
						<input type="text" name="title" placeholder="Title of Category" required> <br><br>
					</div>
					<div class="newsletter-form clearfix">
						<input type="textbox" name="description" placeholder="Describe the need of new category" required> <br><br>
					</div>
								<div class="newsletter-form clearfix">
