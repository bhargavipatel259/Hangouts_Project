			...
			<div class="container">
				<div class="section-content">
					...
					<div class="newsletter-form clearfix">
						<input type="text" name="firstname" placeholder="Title"> <br><br>
					</div>
					<div class="newsletter-form clearfix">
						<input type="text" name="lastname" placeholder="Description"> <br><br>
					</div>
					<div class="newsletter-form clearfix">
						<input type="email" name="email" placeholder="Speaker"> <br><br>
					</div>
					<div class="newsletter-form clearfix">
						<input type="email" name="email" placeholder="Speaker Info"> <br><br>
					</div>
					
					<div class="newsletter-form clearfix">
						<input type="email" name="email" placeholder="Date"> <br><br>
					</div>
					
					<div class="newsletter-form clearfix">
						<input type="password" name="password" placeholder="Time"><br> <br>
					</div>
					<div class="newsletter-form clearfix">
						<input type="password" name="cpassword" placeholder="Venue"><br> <br>
					</div>
					
					<div class="newsletter-form clearfix">
						<input type="submit" value="Create Hangout"><br> <br>
					</div>
					</form>
